...
import { glassdoorDBGetJobPostings, insertPostingsData } from "./searches/Glassdoor/scripts/glassdoorDb.js"
import { testJobPostings } from "./db/test/testJobPostings.js"
...
;(async () => {
  ...
  // insertPostingsData(searchId, testJobPostings)

  
  // const companies = getUniqueCompanies(testJobPostings, 'companyName')
  // console.log("companies: ", companies)
  // const allCompaniesStringList = companies.map(company => company.companyName);
  // console.log("allCompaniesStringList: ", allCompaniesStringList)
